...
- 2026-05-18: Updated the Unity Road Context Pass to use the provided `road_edge_white_line_strip.png` asset instead of procedural white edge lines, imported the new roadside flower border pack, added asset-driven left dirt and right flower shoulder strips, and regenerated RoadOnly B still/motion/close-up captures without car, signs, trees, weather, or background layers.
